        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i>Create Complaint<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('student.create')}}">Student Complaint</a>
                            </li>

                            <li>
                                <a href="{{route('lecturer.create')}}"> Lecturer Complaints</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                               <a href="{{route('student.index')}}">Student Complaint</a>
                            </li>

                            <li>
                                <a href="{{route('lecturer.index')}}">Lecturer Complaint</a>
                            </li>
                            <li>
